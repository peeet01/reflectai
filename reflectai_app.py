...
# 🔑 API kulcs megadása (IDE ILLeszd be majd saját kulcsodat)
API_KEY = "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"
...
# Nyelvi modell hívása (OpenRouter Mistral)
if user_input:
