...
if st.button("Szimuláció és predikció futtatása"):
    ...
    ax2.plot(*pred_states.T, label='Előrejelzett', color='orange')
    ax2.set_title("Predikált Lorenz pálya")
