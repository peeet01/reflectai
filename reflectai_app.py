...
# API kulcs
API_KEY = "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"  # <-- API kulcsodat ide illeszd
...
if user_input:
    ...
    try:
        ...
        if "choices" in result:
            ...
            st.error("❌ Nincs 'choices' mező a válaszban.")
            st.json(result)
