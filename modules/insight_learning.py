...
# 🧠 Modul bemutatása
st.set_page_config(page_title="Insight Learning", layout="wide")
...
🔁 Epizódok: {episodes}
🚶‍♂️ Lépések epizódonként: {max_steps}
...
"""
    ...
    with st.expander("📘 Tudományos háttér – Mi az a belátás?"):
        st.markdown("""
A **belátásos tanulás** (insight learning) egy kognitív folyamat,  
ahol a probléma megoldása nem véletlenszerű próbálkozással,  
...
A szimulált aktivációs térkép azt reprezentálja, hogy az „agy”  
mely régiói milyen gyakran voltak aktívak.  
Amikor az aktiváció meghalad egy *kritikus küszöbszintet*,  
az ügynök felismeri a megoldást – ezt vizualizáljuk  
egy "kitörésként" a 3D domborzati agymodellben.
""")
